...
struct QAHistograms {
  ...
  Configurable<int> _tpcNClsFound{"minTpcNClsFound", 0, "minimum allowed number of TPC clasters"};
  ...
  Configurable<std::vector<float>> _tpcNSigma{"tpcNSigma", std::vector<float>{-3.0f, 3.0f}, "Nsigma range in TPC before the TOF is used"};
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    registry.add("dcaxy_to_p", "dcaxy_to_p", kTH2F, {{100, 0., 5.0, "p"}, {1000, -3., 3., "dcaxy"}});
    registry.add("dcaxy_to_pt", "dcaxy_to_pt", kTH2F, {{100, 0., 5., "pt"}, {1000, -3., 3., "dcaxy"}});
    registry.add("dcaz_to_p", "dcaz_to_p", kTH2F, {{100, 0., 5., "p"}, {1000, -3., 3., "dcaz"}});
    registry.add("dcaz_to_pt", "dcaz_to_pt", kTH2F, {{100, 0., 5., "pt"}, {1000, -3., 3., "dcaz"}});
